...
const AboutMe = ({ isDarkMode }) => {
    ...
    const interestsData = ["Open Source", "System Design", "Tech Communities"];
            ...
            <div className="flex flex-col items-center justify-center min-h-screen p-8 pt-40">
                ...
                >
                    ...
                    <motion.p className="text-lg text-center mb-6 opacity-90">
                        ...
                        developing several simple websites. Has knowledge and experience in
                        HTML, CSS, JavaScript, and PHP with a strong passion for creating
                        user-friendly and visually appealing web solutions. Eager to apply
                        my skills and expand my expertise in a dynamic and challenging
                        environment.
                    </motion.p>
